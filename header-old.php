...
<link href='http://fonts.googleapis.com/css?family=Roboto:400,700,400italic,300,700italic|Roboto+Slab:400,700' rel='stylesheet' type='text/css'>
...
<header role="banner" id="top">
  <div id="sunburst">
    <div class="mobile-search visible-phone" id="utility">
      <div class="utility-collapse collapse">
        <form class="utility-search" role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
      ...
      <a class="btn-search pull-right" data-toggle="collapse" data-target=".utility-collapse">Search <i class="icon-search"></i></a> </div>
...
<div id="banner-image" class="hero-unit container">
  ...
  <div id="myCarousel" class="carousel slide">
    ...
    <!-- Carousel nav -->
    <!-- Carousel nav -->
  <div class="visible-phone"><a class="carousel-control left" href="#myCarousel" data-slide="prev">&lsaquo;</a>
  ...
  <div class="navbar">
    <div class="navbar-inner">
      <div class="container nav-container">
        <nav role="navigation"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">Menu
          <div class="pull-right"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></div>
          </a>
          <div class="nav-drop hidden-phone">
            <?php start_main_nav(); // Adjust using Menus in Wordpress Admin ?>
  			<div id="drawer" class="row-fluid"><!-- I hope nav items append here --></div>
          </div>
          <div class="nav-collapse collapse visible-phone">
            <?php summer_mobile_nav(); // Adjust using Menus in Wordpress Admin ?>
          </div>
        </nav>
      </div>
      <!-- end .nav-container --> 
