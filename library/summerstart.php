...
load_theme_textdomain( 'summerstart', TEMPLATEPATH.'/languages' );
$locale = get_locale();
...
function summer_theme_support() {
	...
	register_nav_menus(                      // wp3+ menus
		array( 
			'main_nav' => 'Main Navigation',   // main nav in header
			'sitemap' => 'Sitemap Page',   // main nav in header
			'footer_links' => 'Footer Links', // secondary nav in footer
			'utility_links' => 'Utility Links', // secondary nav in footer
			'extra_links' => 'Extra Links' // secondary nav in footer
		)
	);	
}
...
function summer_footer_links() { 
    ...
    wp_nav_menu(
    	array(
    		...
    		'fallback_cb' => 'summer_footer_links_fallback' /* menu fallback */
    	)
	);
}
function summer_utility_links() { 
	// display the wp3 menu if available
    wp_nav_menu(
    	array(
    		...
    		'fallback_cb' => 'summer_utility_links_fallback' /* menu fallback */
    	)
	);
}
function summer_extra_links() { 
	// display the wp3 menu if available
    wp_nav_menu(
    	array(
    		'menu' => 'extra_links', /* menu name */
    		'theme_location' => 'extra_links', /* where in the theme it's assigned */
    		'container_class' => 'extra-links clearfix', /* container class */
    		'fallback_cb' => 'summer_utility_links_fallback' /* menu fallback */
    	)
	);
}
